...
class DecoratorNotifySMS(DecoratorNotify):
    def check_subs(self, room):
        print("Notifying via sms.")
        self.object.check_subs(room)


class DecoratorNotifyEmail(DecoratorNotify):
    def check_subs(self, room):
...
decorator_sms = DecoratorNotifySMS(observer)
decorator_email = DecoratorNotifyEmail(observer)
...
reserve_audience(decorator_sms, audience2, user2)
print("-------------------------------------------------")
print("Ivan Olegovish vacates audience number 4.")
print("-------------------------------------------------")
print("Notification to Oleg:")
vacate_audience(decorator_email, audience4)
